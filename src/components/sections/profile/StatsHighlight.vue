<template>
  ...
  >
    <div>
      ...
      <p class="text-sm md:text-base font-light leading-relaxed">Pilihan menu enak</p>
    </div>

    <div>
      <h3 class="text-2xl md:text-[2.5rem] leading-none">250+</h3>
      <p class="text-sm md:text-base font-light leading-relaxed">Pengunjung happy</p>
    </div>
  </section>
</template>
