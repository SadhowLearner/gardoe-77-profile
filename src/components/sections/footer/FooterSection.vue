<template>
  <footer
    class="bg-white/20 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center gap-4 sm:gap-6 px-2 sm:px-4 md:px-8 lg:px-20 py-4 sm:py-6"
  >
    <!-- Social -->
    ...
    <!-- Email -->
    <div
      class="col-span-2 lg:col-span-1 flex justify-center items-center gap-2.5 text-center sm:text-right"
    >
